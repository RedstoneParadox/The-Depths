...
object TheDepths: ModInitializer {
    val DEPTHS_KEY: RegistryKey<World> = RegistryKey.of(Registry.DIMENSION, id("depths"))
    val DEPTHS_TYPE_KEY: RegistryKey<DimensionType> = RegistryKey.of(Registry.DIMENSION_TYPE_KEY, id("depths_type"))
